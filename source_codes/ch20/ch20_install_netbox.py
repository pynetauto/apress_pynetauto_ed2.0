# This script installs netbox 3.6.3  on Ubuntu 22.0.3 LTS server.
# Post the installation completion, you must manually set new admin 
# username and password to log into the first admin page. 
# Introduction to Python Network Automation: The First Journey, 2nd Ed. 
# 03/Oct/2023, Brendan Choi
...
print("!!! Please be patient, the end-to-end installation will take approx. 10 minutes !!!")
print("# 1. Update apt ...")
...
print("# 11. Use Python to generate a secret key and append it to the configuration.py file ...")
...
print("Set admin username and password by running 'python3 manage.py createsuperuser' under '/opt/netbox/netbox' directory!")